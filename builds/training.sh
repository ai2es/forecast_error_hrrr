...
CLIM_DIVS=("Great Lakes" "Hudson Valley" "Mohawk Valley" "Northern Plateau")  
# Replace with your 4 climate divisions
# "St. Lawrence Valley" "Western Plateau" "Coastal" "Central Lakes" "Champlain Valley" "Eastern Plateau"
